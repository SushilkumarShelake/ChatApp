...
export default function Login() {
     ...
     const onSubmit = (data) =>{
        ...
        axios.post("/api/user/login",userInfo).then((response)=>{
            ...
            if(response.data){
                toast.success("Login Successfully! You can now log in");
            }
                ...
                <form  onSubmit={handleSubmit(onSubmit)}  className='border border-white px-6 py-3 rounded-md space-y-3 w-96'>
                    ...
                    {/* username */}
                      ...
                      <div className='flex justify-center'>
                        ...
                        <input type='submit' value="Login" className='text-white bg-blue-600  cursor-pointer w-full rounded-lg py-2'></input>
                      </div>

                    <p> Don't have any account? <Link to={"/signup"} className='text-blue-500 underline cursor-pointer ml-1'>Signup</Link> </p>
